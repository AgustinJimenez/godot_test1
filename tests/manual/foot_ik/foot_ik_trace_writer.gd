...
static func build_foot_trace(ik: Node, side: String,
	...
	return {
		...
		"plan_spacing_requested": plan.spacing_requested if plan != null else false,
		"plan_target_source": plan.target_source if plan != null else "not_planned",
		"plan_adjusted_target": plan.adjusted_ankle_target if plan != null else target,
		"plan_final_adjustment": plan.final_adjustment_reason if plan != null else "not_planned",
		"plan_pelvis_reference": plan.pelvis_reference_reason if plan != null else "not_planned",
		"plan_ankle_target": plan.ankle_target if plan != null else target,
		"plan_proposed_target": plan.proposed_ankle_target if plan != null else target,
