...
## stationary before rising_penalty applies - rising_penalty alone doesn't fully remove idle
## noise sensitivity.
...
## controlled crouch instead of the foot sag an instant settle engage caused. 0.0 disables it.
